...
#define FOR_EACH(_call, _call_end, arg, ...) GET_N_ARGS("ignored", ##__VA_ARGS__, _FOR_EACH_EXPAND_4, _FOR_EACH_EXPAND_3, _FOR_EACH_EXPAND_2, _FOR_EACH_EXPAND_1, _FOR_EACH_EXPAND_0)(_call, _call_end, arg, ##__VA_ARGS__)